**Generated API reference** · package `bw2io` 0.9.17 · module `bw2io.strategies.generic` · generated 2026-09-22 with pydoc-markdown 4.8.2.
...
uvx --python 3.11 --from pydoc-markdown==4.8.2 pydoc-markdown \
  -I "$SP" -m bw2io.strategies.generic cfg.yml > bw2io.strategies.generic.md
```
...
<a id="bw2io.strategies.generic"></a>

# bw2io.strategies.generic

<a id="bw2io.strategies.generic.format_nonunique_key_error"></a>

#### format\_nonunique\_key\_error

```python
def format_nonunique_key_error(obj: dict, fields: List[str],
...
<a id="bw2io.strategies.generic.link_iterable_by_fields"></a>

#### link\_iterable\_by\_fields

```python
def link_iterable_by_fields(unlinked: Iterable[dict],
...
<a id="bw2io.strategies.generic.assign_only_product_as_production"></a>

#### assign\_only\_product\_as\_production
...
<a id="bw2io.strategies.generic.link_technosphere_by_activity_hash"></a>

#### link\_technosphere\_by\_activity\_hash

```python
def link_technosphere_by_activity_hash(db,
...
<a id="bw2io.strategies.generic.set_code_by_activity_hash"></a>

#### set\_code\_by\_activity\_hash

```python
def set_code_by_activity_hash(db: List[dict],
...
<a id="bw2io.strategies.generic.tupleize_categories"></a>

#### tupleize\_categories
...
<a id="bw2io.strategies.generic.drop_unlinked"></a>
...
<a id="bw2io.strategies.generic.normalize_units"></a>
...
<a id="bw2io.strategies.generic.add_database_name"></a>
...
<a id="bw2io.strategies.generic.convert_uncertainty_types_to_integers"></a>

#### convert\_uncertainty\_types\_to\_integers
...
<a id="bw2io.strategies.generic.drop_falsey_uncertainty_fields_but_keep_zeros"></a>

#### drop\_falsey\_uncertainty\_fields\_but\_keep\_zeros

```python
def drop_falsey_uncertainty_fields_but_keep_zeros(
...
<a id="bw2io.strategies.generic.convert_activity_parameters_to_list"></a>

#### convert\_activity\_parameters\_to\_list
...
<a id="bw2io.strategies.generic.split_exchanges"></a>
...
def split_exchanges(
        ...
        allocation_factors: Optional[List[float]] = None) -> List[dict]
```
...
<a id="bw2io.strategies.generic.match_against_top_level_context"></a>

#### match\_against\_top\_level\_context
...
def match_against_top_level_context(
        ...
        kinds: List[str] = labels.biosphere_edge_types) -> List[dict]
```
...
<a id="bw2io.strategies.generic.match_against_only_available_in_given_context_tree"></a>

#### match\_against\_only\_available\_in\_given\_context\_tree
