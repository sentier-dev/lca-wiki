**Generated API reference** · package `randonneur` 0.7.2 · module `randonneur.nodes` · generated 2026-09-22 with pydoc-markdown 4.8.2.
...
uvx --python 3.11 --from pydoc-markdown==4.8.2 pydoc-markdown \
  -I "$SP" -m randonneur.nodes cfg.yml > randonneur.nodes.md
```
...
<a id="randonneur.nodes"></a>

# randonneur.nodes

<a id="randonneur.nodes.verb_dispatch"></a>

#### verb\_dispatch

<a id="randonneur.nodes.migrate_nodes"></a>

#### migrate\_nodes

```python
def migrate_nodes(graph: List[dict],
                  migrations: dict,
...
<a id="randonneur.nodes.migrate_nodes_with_stored_data"></a>

#### migrate\_nodes\_with\_stored\_data
