**Generated API reference** · package `sentier-agribalyse` 0.3.0 · module `readers` · generated 2026-09-22 with pydoc-markdown 4.8.2.
...
uvx --python 3.11 --from pydoc-markdown==4.8.2 pydoc-markdown \
  -I "$SP" -m readers cfg.yml > readers.md
```
